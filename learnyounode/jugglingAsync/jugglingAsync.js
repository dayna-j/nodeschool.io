/*
  ...
  you need to use http.get().
	...
	This time you will be provided with three URLs as the first three command-line arguments.
...
for(let i = 2; i < process.argv.length; i++){urlArray.push(process.argv[i]);}
